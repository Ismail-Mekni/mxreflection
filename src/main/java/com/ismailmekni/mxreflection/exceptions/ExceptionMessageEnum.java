...
enum ExceptionMessageEnum {
    ...
    DUPLICATE_ARGUMENT_NAME_OR_INNER_CLASS("A duplicated name used for different argument in type: %s, also make sure that you don't use inner classes with MxReflection"),
